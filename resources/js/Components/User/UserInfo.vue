...
<template>
    ...
    <div class="flex flex-row-reverse w-full h-full text-md">
        <button @click="togglePopup" v-if="user" class="grid grid-cols-2 gap-1 px-2 cursor-pointer hover:bg-gray-200 hover:dark:bg-gray-800 place-items-center">
